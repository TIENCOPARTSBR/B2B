...
@section('content')
    <section class="page">
        ...
        <div class="card tab-content">
            <form class="row justify-between" method="POST" action="{{ route('distributor.user.store') }}" autocomplete="no">
                @csrf @method('POST')
                <div class="col-lg-6 mb-1">
                    <input type="hidden" name="distributor_id" value="{{Auth::guard('distributor')->user()->distributor_id}}">
