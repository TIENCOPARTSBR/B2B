    ...
    <section class="page">
        ...
        <div class="card">
            <div class="tab-nav">
                ...
                <a href="{{route('direct.distributor.product.value.import.index')}}" class="tab-link active" type="button">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane show" id="nav-excel">
                    <form action="{{ route('direct.distributor.product.value.import.import') }}" class="tab-header mb-0" id="form_import" enctype="multipart/form-data">
                        @csrf @method('POST')
                    ...
                    <div class="table d-none">
                        ...
                        <form method="POST" action="{{route('direct.distributor.product.value.import.store')}}" class="table-row-group">
                            @csrf @method('POST')
                        </form>
                    </div>
                </div>
