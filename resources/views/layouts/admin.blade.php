    ...
    <div class="app">
        <nav class="sidebar open">
            <ul class="si-list">
                ...
                <li class="si-item">
                    <a href="{{ url('/admin') }}" class="si-link">
                        <div class="si-icon">
                ...
                <li class="si-item">
                    <a href="{{ url('/admin/produtos') }}" class="si-link">
                        <div class="si-icon">
                ...
                <li class="si-item">
                    <a href="{{ url('/admin/usuarios') }}" class="si-link">
                        <div class="si-icon">
                ...
                <li class="si-item">
                    <a href="{{ url('/admin/distribuidor') }}" class="si-link">
                        <div class="si-icon">
                ...
                <li class="si-item">
                    <a href="{{ url('/admin/config') }}" class="si-link">
                        <div class="si-icon">
               ...
               {{--  <li class="si-item">
                    <a href="{{ url('/admin/empresas') }}" class="si-link">
                        <div class="si-icon">
                            <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="1" y="4" width="16" height="14" rx="2" stroke-width="2"/>
                                <path d="M5 2V6" stroke-width="2" stroke-linecap="round"/>
                                <path d="M13 2V6" stroke-width="2" stroke-linecap="round"/>
                                <path d="M5 1H13" stroke-width="2" stroke-linecap="round"/>
                            </svg>
                        </div>
                        ...
                        <ul class="submenu">s
                            <li class="sb-item">
                                <a href="sb-link">{{ __('messages.Home') }}</a>
                            </li>
                        </ul>
                    </a>
                </li> --}}
