...
<body>
            ...
            <div class="container">
                ...
                <nav class="menu">
                    <ul class="list-menu">
                        ...
                        <li class="item-menu">
                            <a href="{{route('distributor.product.index')}}" class="link-menu">
                                <div class="icon-menu">
                        ...
                        <li class="item-menu">
                            <a href="{{route('distributor.quotation.index')}}" class="link-menu">
                                <div class="icon-menu">
                        ...
                        <li class="item-menu">
                            <a href="{{ route('distributor.user.index') }}" class="link-menu">
                                <div class="icon-menu">
                    ...
                    <div class="d-flex">
                        <div class="language">
                            <button class="select">
                                @if (app()->getLocale() == 'pt')
                                    <img src="https://encoparts.com/wp-content/plugins/sitepress-multilingual-cms/res/flags/pt-br.png" alt="PT-BR">
                                @elseif(app()->getLocale() == 'en')
                                    <img src="https://encoparts.com/wp-content/uploads/flags/us.png" alt="EUA">
    ...
    @component('component.quotation.delete-quotation')
    @endcomponent
